...
import (
	...
	"github.com/cosmos-builders/chaos/utils"
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig appparams.EncodingConfig) {
	...
	rootCmd.AddCommand(
		...
		genutilcli.CollectGenTxsCmd(banktypes.GenesisBalancesIterator{}, app.DefaultNodeHome, gentxModule.GenTxValidator, address.NewBech32Codec(appparams.Bech32PrefixValAddr)),
		genutilcli.MigrateGenesisCmd(genutilcli.MigrationMap),
		genutilcli.GenTxCmd(app.ModuleBasics, encodingConfig.TxConfig, banktypes.GenesisBalancesIterator{}, app.DefaultNodeHome, address.NewBech32Codec(appparams.Bech32PrefixValAddr)),
...
func txCommand() *cobra.Command {
	...
	cmd.AddCommand(
		...
		vestingcli.GetTxCmd(address.NewBech32Codec(appparams.Bech32Prefix)),
	)
...
func (a appCreator) appExport(logger log.Logger, db dbm.DB, traceStore io.Writer, height int64, forZeroHeight bool, jailAllowedAddrs []string, appOpts servertypes.AppOptions, modulesToExport []string) (servertypes.ExportedApp, error) {
	var anApp *app.App
